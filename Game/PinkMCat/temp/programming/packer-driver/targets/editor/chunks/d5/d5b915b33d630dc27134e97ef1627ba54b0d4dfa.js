System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Label, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, DetailsView;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("DetailsView", DetailsView = (_dec = ccclass('DetailsView'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec(_class = (_class2 = class DetailsView extends Component {
        constructor(...args) {
          super(...args);
...
//# sourceMappingURL=d5b915b33d630dc27134e97ef1627ba54b0d4dfa.js.map