System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, tween, Lobby, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, Cat;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Cat", Cat = (_dec = ccclass('Cat'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class Cat extends Component {
        constructor(...args) {
          super(...args);
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "moveList", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "moveNode", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=a3c82783eff9bec2ebae003fc0704293e4d8b824.js.map