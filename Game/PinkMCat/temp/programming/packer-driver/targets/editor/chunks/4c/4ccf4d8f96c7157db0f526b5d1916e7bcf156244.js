        ...
        _init() {
          ...
          if (!t._sizeType) {
            t._scrollView._onTouchMoved = function (event, captureListeners) {
              ...
              let deltaMove = touch.getUIDelta(); // console.log(deltaMove.x,deltaMove.y,t.node.parent.name);
                ...
                for (const listener of captureListeners) {
                  ...
                  if (this.node === item) {
                    if (event.target && event.target.getComponent(ViewGroup)) {
                      let deltaMove = event.getUIDelta(); // console.log(deltaMove.x,deltaMove.y,t.node.parent.name);
...
//# sourceMappingURL=4ccf4d8f96c7157db0f526b5d1916e7bcf156244.js.map