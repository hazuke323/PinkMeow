System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, resources, Sprite, SpriteFrame, ListItem, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, foodItem;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("foodItem", foodItem = (_dec = ccclass('foodItem'), _dec2 = property(Sprite), _dec(_class = (_class2 = class foodItem extends (_crd && ListItem === void 0 ? (_reportPossibleCrUseOfListItem({
        error: Error()
      }), ListItem) : ListItem) {
        constructor() {
          super(...arguments);
...
//# sourceMappingURL=0c3161c2271140bb1552c162297985a551e37562.js.map