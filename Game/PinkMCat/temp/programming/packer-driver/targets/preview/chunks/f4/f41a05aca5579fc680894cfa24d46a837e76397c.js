System.register(["__unresolved_0", "cc", "cc/env", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Node, Component, Enum, tween, _decorator, EventHandler, ScrollView, Prefab, Layout, Vec2, Size, NodePool, isValid, instantiate, Vec3, Widget, UITransform, CCFloat, CCBoolean, CCInteger, EventTouch, SystemEventType, ViewGroup, DEV, Log, ListItem, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _crd, ccclass, property, disallowMultiple, menu, executionOrder, requireComponent, TemplateType, SlideType, SelectedType, _tempVec2, _tempVec2_1, List;
  ...
  function _reportPossibleCrUseOfLog(extras) {
    _reporterNs.report("Log", "../../../Library/Base/Log", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ViewGroup = _cc.ViewGroup;
    }, function (_ccEnv) {
      DEV = _ccEnv.DEV;
    }, function (_unresolved_2) {
      Log = _unresolved_2.default;
    }, function (_unresolved_3) {
      ListItem = _unresolved_3.default;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "f0aedKZJ+9HxLzKT4Ki31Cg", "List", undefined);
      ...
      __checkObsolete__(['Node', 'Component', 'Enum', 'tween', '_decorator', 'EventHandler', 'Tween', 'ScrollView', 'Prefab', 'Layout', 'Vec2', 'Size', 'NodePool', 'isValid', 'instantiate', 'Vec3', 'Widget', 'UITransform', 'CCFloat', 'CCBoolean', 'CCInteger', 'EventTouch', 'SystemEventType', 'ViewGroup']);
      ...
      _export("default", List = (_dec = disallowMultiple(), _dec2 = menu('List'), _dec3 = requireComponent(ScrollView), _dec4 = executionOrder(-5000), _dec5 = property({
        ...
        set numItems(val) {
          ...
          if (val == null || val < 0) {
            (_crd && Log === void 0 ? (_reportPossibleCrUseOfLog({
              error: Error()
            }), Log) : Log).error('numItems set the wrong::', val);
            return;
          }
        ...
        _init() {
          ...
          if (!t.content) {
            (_crd && Log === void 0 ? (_reportPossibleCrUseOfLog({
              error: Error()
            }), Log) : Log).error(t.node.name + "'s ScrollView unset content!");
            return;
          }
          ...
          if (!t._sizeType) {
            t._scrollView._onTouchMoved = function (event, captureListeners) {
              if (!this.enabledInHierarchy || !this._content) {
                return;
              }

              var touch = event.touch;
              var deltaMove = touch.getUIDelta(); // console.log(deltaMove.x,deltaMove.y,t.node.parent.name);
            ...
            t._scrollView._hasNestedViewGroup = function (event, captureListeners) {
              ...
              if (captureListeners) {
                ...
                for (var listener of captureListeners) {
                  var item = listener;

                  if (this.node === item) {
                    if (event.target && event.target.getComponent(ViewGroup)) {
                      var deltaMove = event.getUIDelta(); // console.log(deltaMove.x,deltaMove.y,t.node.parent.name);
            ...
            t._scrollView._onTouchEnded = function (event, captureListeners) {
              if (!this.enabledInHierarchy || !this._content) {
                return;
              }
            ...
            t._scrollView._onTouchCancelled = function (event, captureListeners) {
              if (!this.enabledInHierarchy || !this._content) {
                return;
        ...
        checkInited(printLog) {
          ...
          if (!this._inited) {
            if (printLog) (_crd && Log === void 0 ? (_reportPossibleCrUseOfLog({
              error: Error()
            }), Log) : Log).error('List initialization not completed!');
            return false;
          }
        ...
        aniDelItem(listId, callFunc, aniType) {
          var t = this;
          if (!t.checkInited() || t.cyclic || !t._virtual) return (_crd && Log === void 0 ? (_reportPossibleCrUseOfLog({
            error: Error()
          }), Log) : Log).error('This function is not allowed to be called!');
          if (!callFunc) return (_crd && Log === void 0 ? (_reportPossibleCrUseOfLog({
            error: Error()
          }), Log) : Log).error('CallFunc are not allowed to be NULL, You need to delete the corresponding index in the data array in the CallFunc!');
          if (t._aniDelRuning) return (_crd && Log === void 0 ? (_reportPossibleCrUseOfLog({
            error: Error()
          }), Log) : Log).warn('Please wait for the current deletion to finish!');
        ...
        scrollTo(listId, timeInSecond, offset, overStress) {
          ...
          if (!pos) {
            return DEV && (_crd && Log === void 0 ? (_reportPossibleCrUseOfLog({
              error: Error()
            }), Log) : Log).error('pos is null', listId);
          }
        ...
        skipPage(pageNum, timeInSecond) {
          var t = this;
          if (!t.checkInited()) return;
          if (t._slideMode != SlideType.PAGE) return (_crd && Log === void 0 ? (_reportPossibleCrUseOfLog({
            error: Error()
          }), Log) : Log).error('This function is not allowed to be called, Must SlideMode = PAGE!');
        ...
        calcCustomSize(numItems) {
          var t = this;
          if (!t.checkInited()) return;
          if (!t._itemTmp) return (_crd && Log === void 0 ? (_reportPossibleCrUseOfLog({
            error: Error()
          }), Log) : Log).error('Unset template item!');
          if (!t.renderEvent) return (_crd && Log === void 0 ? (_reportPossibleCrUseOfLog({
            error: Error()
          }), Log) : Log).error('Unset Render-Event!');
          t._customSize = {};
...
//# sourceMappingURL=f41a05aca5579fc680894cfa24d46a837e76397c.js.map